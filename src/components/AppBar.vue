<template>
  <div>
    <v-app-bar dark color="primary" class="flex-grow-0">
      <v-app-bar-title id="title">MoonHook</v-app-bar-title>
      <v-spacer></v-spacer>
      <v-btn fab small class="mr-2" @click="openSettings()">
        <v-icon dark>mdi-cog</v-icon>
      </v-btn>
      <v-btn class="mr-2" @click="openLink('Darw1n#6125')">
      ...
      <v-dialog v-model="showCredits" width="500">
        <v-card>
          ...
          <v-card-text class="mt-5">
             MoonHook
             <br />
             Official software of MoonHook Team
             <br /><br />
             Designed and coded by
             <strong>Darw1n</strong><br /><br />
             A big thanks to
             <ul>
                 <li>
                 ...
                 ">Lunar Client Lite</a>
                  ...
                  <li>
                      <strong>Ionutelul</strong> for being a super cool person,
                      promoting and trusting me.
                      <a @click="openLink('https://www.youtube.com/c/69666')">Our YouTube channel</a>
                      <v-icon color="blue" size="20" class="ml-1">mdi-open-in-new</v-icon>
                  </li>
              </ul>
              <br />
              <span class="version">MoonHook <strong>v{{ softwareVersion }}</strong></span>
          </v-card-text>
          <v-divider></v-divider>
          <v-card-actions>
            <v-btn
